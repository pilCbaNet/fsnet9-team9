...
namespace CryptoAPI2.Models
{
    public partial class BestWalletContext : DbContext
    {
        ...
        public virtual DbSet<ResumenSaldo> ResumenSaldos { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                //optionsBuilder.UseSqlServer("Server=LAPTOP-EJU6PHOH; Database=BestWallet; User=sa; Password=12345678; TrustServerCertificate=True");
                optionsBuilder.UseSqlServer("Server=DESKTOP-MH7C94A; Database=BestWallet; User=sa; Password=123456; TrustServerCertificate=True");
            }
        }
